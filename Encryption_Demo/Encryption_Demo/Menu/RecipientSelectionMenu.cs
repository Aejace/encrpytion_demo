...
{
    internal class RecipientSelectionMenu : Menu
    {
        private List<string> userNames;
        private List<string> selectedUsers = new List<string>();
        public RecipientSelectionMenu(DemoEnvironment environment) : base(environment)
        {
        ...
        {
            Console.WriteLine("");
            Console.WriteLine("Message recipient selection menu");
            ...
            else
            {
                switch (userInput)
                {
                    ...
                    case "ACCEPT" when selectedUsers.Count > 0:
                        Environment.CurrentUser.PartialMessage.RecipientsList = selectedUsers;
                        Console.Write("Recipients Selected: ");
                        foreach (string user in selectedUsers)
                        {
                            Console.Write(user + ", ");
                        }
